...
class ModelEvaluation:
    ...
    def __init__(self,
        ...
        try:
            ...
            self.data_transformation= DataTransformation(data_transformation_config=config_entity.DataTransformationConfig, data_ingestion_artifact=artifact_entity.DataIngestionArtifact)
